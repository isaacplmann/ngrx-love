...
export const getPast = (state: any) => state.past;
export const getPresent = (state: any) => state.present;
export const getFuture = (state: any) => state.future;
